...
class Persona {
    ...
    get mostrarGeneracion() {
        ...
        switch (true) {
            case (this.anioNac >= 1930 && this.anioNac <= 1948):
                para.innerHTML = `${this.nombre} nació en el año ${this.anioNac}
                1930-1948 - Silent Generation (Los niños de la posguerra)
                Rango carasterístico: Austeridad`
                // Append to another element:
                document.getElementById("setInfo").appendChild(para);
                break;
            case (this.anioNac >= 1949 && this.anioNac <= 1968):
                para.innerHTML = `${this.nombre} nació en el año ${this.anioNac}
                1949-1968 - Baby Boom
                Rango carasterístico: Ambición`
                // Append to another element:
                document.getElementById("setInfo").appendChild(para);
                break;
            case (this.anioNac >= 1969 && this.anioNac <= 1980):
                ...
                Rango carasterístico: Obsesión por el éxito`
                // Append to another element:
                document.getElementById("setInfo").appendChild(para);
                break;
            case (this.anioNac >= 1981 && this.anioNac <= 1993):
                para.innerHTML = `${this.nombre} nació en el año ${this.anioNac}
                1981-1993 - Generación Y (millennials)
                Rango carasterístico: Frustración`
                // Append to another element:
                document.getElementById("setInfo").appendChild(para);
                break;
            case (this.anioNac >= 1994 && this.anioNac <= 2010):
                ...
                Rango carasterístico: Irreverencia`
                // Append to another element:
                document.getElementById("setInfo").appendChild(para);
                break;
            default:
                this.anioNac > 2010 ? para.innerHTML = "Sin generacion, Muy joven" : para.innerHTML = "Sin generacion, Muy viejo";
                // Append to another element:
                document.getElementById("setInfo").appendChild(para);
                break;
        }
    ...
    get esMayorDeEdad() {
        ...
        (anio - this.anioNac) >= 18 ? para.innerHTML = `${this.nombre} es Mayor de edad` : para.innerHTML = `${this.nombre} es Menor de edad`;
...
const altaPersona = () => {
    const nom = document.querySelector('#validationTooltip01').value,
        edad = document.querySelector('#validationTooltip02').value,
        sex = document.querySelector('input[name="flexRadioDefault"]:checked').value,
        peso = document.querySelector('#validationTooltip04').value,
        altura = document.querySelector('#validationTooltip05').value,
        anioNac = document.querySelector('#validationTooltip06').value;

    newPersona = new Persona(nom, edad, sex, peso, altura, anioNac);
}
